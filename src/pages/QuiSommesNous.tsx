      ...
      <section className="py-20 bg-background">
        <div className="max-w-5xl mx-auto px-4">
          <motion.div
            ...
            <p className="text-base md:text-lg font-body text-muted-foreground leading-relaxed max-w-3xl mx-auto">Le FOCEEN (Forum Centrale Méditerranée Entreprises) est une association de l'École Centrale de Méditerranée composée de 28 étudiants-ingénieurs passionnés. Chaque année, ces étudiants organisent le plus grand forum de recrutement ingénieur de la région Sud-Est, réunissant entreprises, écoles et talents autour d'un événement unique.28 étudiants-ingénieurs passionnés. Chaque année, nous organisons ce forum de recrutement ingénieur, réunissant entreprises, écoles et talents autour d'un événement unique.
